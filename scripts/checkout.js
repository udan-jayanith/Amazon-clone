...
day7.innerText = moment().add(7, 'days').format('dddd MMMM D')
day3.innerText = moment().add(3, 'days').format('dddd MMMM D')
day1.innerText = moment().add(1, 'days').format('dddd MMMM D')